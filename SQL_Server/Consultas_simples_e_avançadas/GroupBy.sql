...
-- MEDIA DE CREDITO POR CIDADE
SELECT CIDADE, 
	AVG(LIMITE_DE_CREDITO) AS MÉDIA_CRÉDITO  
FROM TABELA_DE_CLIENTES
GROUP BY CIDADE;
...
-- TRAZ A QTD DE PRODUTOS DAS EMBALAGENS EXISTENTES
SELECT
  EMBALAGEM,
  COUNT(*) AS QTD_PRODUTOS --obter a quantidade de produtos de cada tipo.
FROM TABELA_DE_PRODUTOS
GROUP BY EMBALAGEM;
...
GROUP BY CODIGO_DO_PRODUTO, QUANTIDADE;
-- RESP 3