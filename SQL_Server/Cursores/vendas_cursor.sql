/* 
Temos uma tabela chamada vendas cujos campos são data_venda e valor_venda. 
Crie um Cursor que vai carregar os dados da tabela e, ao percorrer linha a linha, 
verifique o mês correspondente à data e incrementar o valor na variável correspondente ao mês.
*/

-- Declarcação e inicialização das variáveis:
...
-- Declarar, incluir os dados e abrir o Cursor.
...
--Loop percorrendo cada linha do Cursor e jogando o valor da venda na variável correta.
