...
SELECT DISTINCT EMBALAGEM FROM TABELA_DE_PRODUTOS; -- TIRA A REPETIÇÃO DE LINHAS COM O MEMSO DADO
...
-- ORDENA TANTO EMBALAGEM QUANTO NOME_DO_PRODUTO EM ORDEM ASC
